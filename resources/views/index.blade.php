			...
			<div class="container">
				...
				<div class="row">
					...
					<div class="col-md-4 col-xs-6">
						<div class="shop">
							<div class="shop-img">
								<img src="templates/img/shop01.png" alt="">
							</div>
							<div class="shop-body">
								<h3>Laptop<br>Collection</h3>
								<a href="#" class="cta-btn">Your Donation <i class="fa fa-arrow-circle-right"></i></a>
							</div>
						</div>
					</div>
					<!-- /shop -->
					...
					<div class="col-md-4 col-xs-6">
						<div class="shop">
							<div class="shop-img">
								<img src="templates/img/shop03.png" alt="">
							</div>
							<div class="shop-body">
					...
					<div class="col-md-4 col-xs-6">
						<div class="shop">
							<div class="shop-img">
								<img src="templates/img/shop02.png" alt="">
							</div>
							<div class="shop-body">
									...
									<div class="products-slick" data-nav="#slick-nav-1">
										...
										<div class="product">
											...
											<div class="add-to-cart">
												<button class="add-to-cart-btn"><i class="fa fa-shopping-cart"></i> Get Your Product</button>
											</div>
										</div>
										<!-- /product -->
				...
				<div class="row">
					<div class="col-md-12">
						<div class="hot-deal">
							...
							<a class="primary-btn cta-btn" href="#">Your Donation</a>
						</div>
					</div>
				</div>
				<!-- /row -->
