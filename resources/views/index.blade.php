...
<body>
	...
	<div class="hero overlay" style="background-image: url('templates/images/hero_2.jpg')">
		<div class="container">
	...
	<div class="section flip-section" style="background-image: url('templates/images/img_v_2-min.jpg')">
		<div class="blob-1">
			<img src="templates/images/blob.png" alt="Image" class="img-fluid">
		</div>
		<div class="container">
			...
			<div class="row justify-content-between">
				...
				<div class="col-lg-6">
					<div class="overlap-imgs">
						<img src="templates/images/img_v_2-min.jpg" alt="Image" class="img-fluid rounded" data-aos="fade-up" data-aos="100">
						<img src="templates/images/img_v_3-min.jpg" alt="Image" class="img-fluid rounded" data-aos="fade-up" data-aos="200">
					</div>
				</div>		
			</div>		
		</div>		
				...
				<div class="features-slider" id="features-slider">
					...
					<div class="item">
						<div class="causes-item bg-white">
							<a href="#"><img src="templates/images/img_v_1-min.jpg" alt="Image" class="img-fluid mb-4 rounded"></a>
					...
					<div class="item">
						<div class="causes-item bg-white">
							<a href="#"><img src="templates/images/img_v_2-min.jpg" alt="Image" class="img-fluid mb-4 rounded"></a>
							<div class="px-4 pb-5 pt-3">
					...
					<div class="item">
						<div class="causes-item bg-white">
							<a href="#"><img src="templates/images/img_v_3-min.jpg" alt="Image" class="img-fluid mb-4 rounded"></a>
							<div class="px-4 pb-5 pt-3">
					...
					<div class="item">
						<div class="causes-item bg-white">
							<a href="#"><img src="templates/images/img_v_4-min.jpg" alt="Image" class="img-fluid mb-4 rounded"></a>
							<div class="px-4 pb-5 pt-3">
					...
					<div class="item">
						<div class="causes-item bg-white">
							<a href="#"><img src="templates/images/img_v_5-min.jpg" alt="Image" class="img-fluid mb-4 rounded"></a>
							<div class="px-4 pb-5 pt-3">
								<h3><a href="#">Education for Children</a></h3>
								<p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Soluta labore eligendi tempora laudantium voluptate, amet ad libero facilis nihil officiis.</p>
					...
					<div class="item">
						<div class="causes-item bg-white">
							<a href="#"><img src="templates/images/img_v_6-min.jpg" alt="Image" class="img-fluid mb-4 rounded"></a>
							<div class="px-4 pb-5 pt-3">
								<h3><a href="#">Support Livelihood</a></h3>
								<p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Soluta labore eligendi tempora laudantium voluptate, amet ad libero facilis nihil officiis.</p>
	...
	<div class="section flip-section secondary-bg" style="background-image: url('templates/images/img_v_4-min.jpg')">
		<div class="container">
			<div class="row">
			...
			<div class="instagram-slider" id="instagram-slider">
				...
				<div class="item">
					<a class="instagram-item">
						...
						<img src="templates/images/img_v_8-min.jpg" alt="Image" class="img-fluid">		
					</a>
				</div>
				...
				<div class="item">
					<a class="instagram-item">
						<span class="icon-instagram"></span>
						<img src="templates/images/img_v_2-min.jpg" alt="Image" class="img-fluid">		
					</a>
				</div>
				...
				<div class="item">
					<a class="instagram-item">
						<span class="icon-instagram"></span>
						<img src="templates/images/img_v_3-min.jpg" alt="Image" class="img-fluid">		
					</a>
				</div>
				...
				<div class="item">
					<a class="instagram-item">
						<span class="icon-instagram"></span>
						<img src="templates/images/img_v_4-min.jpg" alt="Image" class="img-fluid">		
					</a>
				</div>
				...
				<div class="item">
					<a class="instagram-item">
						<span class="icon-instagram"></span>
						<img src="templates/images/img_v_5-min.jpg" alt="Image" class="img-fluid">		
					</a>
				</div>
				...
				<div class="item">
					<a class="instagram-item">
						<span class="icon-instagram"></span>
						<img src="templates/images/img_v_6-min.jpg" alt="Image" class="img-fluid">		
					</a>
				</div>
				...
				<div class="item">
					<a class="instagram-item">
						<span class="icon-instagram"></span>
						<img src="templates/images/img_v_7-min.jpg" alt="Image" class="img-fluid">		
					</a>
				</div>
